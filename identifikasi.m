...
%      IDENTIFIKASI, by itself, creates a new IDENTIFIKASI or raises the existing
%      singleton*.
%
%      H = IDENTIFIKASI returns the handle to a new IDENTIFIKASI or the handle to
%      the existing singleton*.
%
%      IDENTIFIKASI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in IDENTIFIKASI.M with the given input arguments.
%
%      IDENTIFIKASI('Property','Value',...) creates a new IDENTIFIKASI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before identifikasi_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to identifikasi_OpeningFcn via varargin.
%
...
% Last Modified by GUIDE v2.5 25-Jan-2023 15:17:18
...
% varargin   command line arguments to identifikasi (see VARARGIN)
...
if isempty(id)
    ...
    switch id
        case 1
            tingkat = 'Pakai Masker';
        case 2
            tingkat = 'Tidak Pakai Masker';
        case 3
            tingkat = 'Tidak Pakai Masker';
        case 4
            tingkat = 'Pakai Masker';
